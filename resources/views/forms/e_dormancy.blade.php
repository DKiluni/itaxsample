...
<div id="formSectionContainer">
    ...
    <div class="form-container" style="border: 1px solid #DA3832; border-radius: 4px; box-shadow: none; overflow: hidden; margin-top: 5px;">
        ...
        <div class="form-body" style="padding: 5px;">
            ...
            <!-- Tax Obligation(s) for Dormance Section -->
            <fieldset class="red-fieldset">
                <legend class="red-legend">Tax Obligation(s) for Dormance</legend>
                <table class="inner-profile-table">
                    <thead>
                        <tr>
                            <th style="padding: 8px; border: 1px solid #ccc; text-align: left; width: 33%;">Tax Obligation(s)</th>
                            <th style="padding: 8px; border: 1px solid #ccc; text-align: left; width: 33%;">Effective From Date<span class="required-star">*</span></th>
                            <th style="padding: 8px; border: 1px solid #ccc; text-align: left; width: 33%;">Effective To Date<span class="required-star">*</span></th>
                        </tr>
                    </thead>
                    <tbody id="dormancy-obligations-tbody">
                        <!-- Dynamic rows go here -->
                    </tbody>
                </table>
            </fieldset>

            <!-- Reason(s) for Dormance Section -->
            <fieldset class="red-fieldset">
                <legend class="red-legend">Reason(s) for Dormance<span class="required-star">*</span></legend>
                <table class="inner-profile-table">
                    <tbody>
                        <tr>
                            <td style="width: 50%;">Travelling Out of Country</td>
                            <td style="width: 50%; text-align: center;"><input type="checkbox"></td>
                        </tr>
                        <tr>
                            <td>Business Termination</td>
