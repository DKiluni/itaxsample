...
<div class="form-container-red">
    ...
    <div id="section-app" class="tab-pane active" style="padding: 0;">
        ...
        <div style="text-align: center; margin-top: 20px; padding-bottom: 20px;">
            ...
            <button type="button" class="btn-submit-orange" onclick="showTab('goods')" style="border-radius: 4px; padding: 8px 30px; margin-left: 10px;">Next</button>
        </div>
    </div>
    ...
    <div id="section-goods" class="tab-pane" style="padding: 0;">
        ...
        <div style="text-align: center; margin-top: 20px; padding-bottom: 20px;">
            <button type="button" class="btn-cancel-red" onclick="showTab('app')" style="border-radius: 4px; padding: 8px 30px;">Previous</button>
